...
const stream = document.querySelector('.stream button'); 
...
container.addEventListener("mouseenter", (e) => {
    ...
    stream.style.transform = "translateZ(75px)";
...
container.addEventListener("mouseleave", (e) => {
   ...
   stream.style.transition = "all 0.5s ease";
    card.style.transform = `rotateY(0deg) rotateX(0deg)`;
        ...
        stream.style.transform = "translateZ(0px)";
